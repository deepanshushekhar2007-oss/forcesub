...
async def smart_group_otp_detect(message: Message):
    ...
    # Extract last 3 digits (masked number support)
    number_match = re.search(r"(\d{3})\D*(\d{3})$", text)
